...
<body>
	...
	%>
	<a href="Car.jsp"><input onclick="this.parentNode.href=Car.jsp;"
		type="button" value="Go Back" name="Fail" /></a>
	<%
	} else {
	//Make INSERT vehicles query
	PreparedStatement statement = con
			.prepareStatement("INSERT IGNORE INTO vehicles (vid, itemName, minPrice, country, container) VALUES (?, ?, ?, ?, 1)");
	...
	PreparedStatement statement2 = con.prepareStatement(
			"INSERT IGNORE INTO auction (available, username, vid, endtime) values (true, ?, ?, date(?))");
...
<body>
	...
	<a href="HomePage.jsp"><input
		...
		value="Go Back Home" name="gobackhome" /></a>
</body>
<%
}
